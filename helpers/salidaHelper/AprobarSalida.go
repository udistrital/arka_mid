...
func AprobarSalida(salidaId int, res *models.ResultadoMovimiento) (outputError map[string]interface{}) {
	...
	if msg, err := asientoContable.CalcularMovimientosContables(elementosActa, dsc, tipoMovimiento, salida.Funcionario, bufferCuentas, &transaccion.Movimientos); err != nil || msg != "" {
		res.Error = msg
		return err
	}
