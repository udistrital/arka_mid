...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/udistrital/arka_mid/controllers:AuditoriaController"] = append(beego.GlobalControllerRouter["github.com/udistrital/arka_mid/controllers:AuditoriaController"],
        beego.ControllerComments{
            Method: "PostEvento",
            Router: `/evento`,
            AllowHTTPMethods: []string{"post"},
    ...
    beego.GlobalControllerRouter["github.com/udistrital/arka_mid/controllers:ReportesController"] = append(beego.GlobalControllerRouter["github.com/udistrital/arka_mid/controllers:ReportesController"],
        beego.ControllerComments{
            Method: "PostReporteContabilizacion",
            Router: `/contabilizacion`,
            AllowHTTPMethods: []string{"post"},
            MethodParams: param.Make(),
            Filters: nil,
            Params: nil})
    ...
    beego.GlobalControllerRouter["github.com/udistrital/arka_mid/controllers:ReportesController"] = append(beego.GlobalControllerRouter["github.com/udistrital/arka_mid/controllers:ReportesController"],
        beego.ControllerComments{
            Method: "GetDetalleCuentasSalida",
            Router: `/detalle_cuentas_salida`,
            AllowHTTPMethods: []string{"get"},
            MethodParams: param.Make(),
            Filters: nil,
            Params: nil})
